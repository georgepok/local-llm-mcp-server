# STAGE 4c — the QUARANTINED formed-stake experiment ON THE CANONICAL LTC SUBSTRATE (1c belief: tau spectrum alive
...
ck2 = torch.load('/home/pokazge/checkpoints/stage2c_distill.pt', weights_only=False, map_location='cpu')   # LTC substrate: slot distilled on the 1c belief (KL-red +0.125)
...
class SlotHead(nn.Module):
    ...
    def forward(s, h):
        ...
        return o
slot = SlotHead(D, TGT, nkv, hd).to(dev); slot.load_state_dict(ck2['slot']); slot.eval()
