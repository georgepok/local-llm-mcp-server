...
B="SMOKE=0 LIFE=30 KCONT=3 GAIN0=1.0 FLAT=0 READMODE=gnn WRITE=off READT=1.0 ALIGN=1.0 GATE=none SLOW_DIM=32 DECOUPLE=0 DISTRACT=0 JUDGE=1 PHASE=1 PHASEF=1 REACTIVE=1"
echo "##### SMOKE v2collect (world_state damage) #####"; env $B SEED=0 LORA=goal VIABILITY=v2collect GOAL="$G" python -u organism3.py
echo "##### SMOKE v2deploy #####"; env $B SEED=0 LORA=goal VIABILITY=v2deploy GOAL="$G" python -u organism3.py
echo "=== SMOKE_V22D_DONE ==="
