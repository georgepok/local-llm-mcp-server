...
echo "============================================"
echo "  Experiment A-v4b — lambda=1.0 (10x stronger)"
echo "============================================"
...
python scripts/train_resonant.py \
    ...
    --output_dir output_resonant_v4b_lambda1.0

echo ""
echo "============================================"
echo "  Fidelity Checkpoints"
echo "============================================"

for CKPT in step_1000 step_2000 final; do
    CKPT_PATH="output_resonant_v4b_lambda1.0/checkpoints/${CKPT}.pt"
    if [ -f "$CKPT_PATH" ]; then
        echo ""
        echo "--- Fidelity @ ${CKPT} ---"
...
echo ""
echo "============================================"
echo "  Experiment A-v4b Complete"
echo "============================================"
