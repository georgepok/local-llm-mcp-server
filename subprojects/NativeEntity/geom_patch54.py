...
if 'def critical_phase2()' in src:
    print('ALREADY'); raise SystemExit
anchor = "if MODE == 'validate':   validate()"
src = src.replace(anchor, FN + '\n\n' + anchor, 1)
src = src.replace("elif MODE == 'critical_gate_v2': critical_gate_v2()",
                  "elif MODE == 'critical_gate_v2': critical_gate_v2()\nelif MODE == 'critical_phase2': critical_phase2()", 1)
