...
if 'def habitat_integrity4()' in src:
    print('ALREADY'); raise SystemExit
anchor = "if MODE == 'validate':   validate()"
src = src.replace(anchor, FN + '\n\n' + anchor, 1)
src = src.replace("elif MODE == 'habitat_integrity3': habitat_integrity3()",
                  "elif MODE == 'habitat_integrity3': habitat_integrity3()\nelif MODE == 'habitat_integrity4': habitat_integrity4()", 1)
